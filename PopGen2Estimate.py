...
for ind_s in range(len(s)):
        for ind_r in range(len(r)):
                ...
                np.savez('Results/WF/selcof_2_lls', estimate_lls=estimate_lls, MSE_mean_lls=MSE_mean_lls, MSE_std_lls=MSE_std_lls, runtime_lls=runtime_lls, data=data_obs)
                ...
                np.savez('Results/WF/selcof_2_mcmc', estimate_da=estimate_mcmc, MSE_mean=MSE_mean_mcmc, MSE_std=MSE_std_mcmc, runtime=runtime_mcmc, data = data_obs)