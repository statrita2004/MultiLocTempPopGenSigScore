...
plt.plot(postmean[0], postmean[1], 'r+', markersize=30, label='posterior mean')
plt.plot(s[1][0], s[1][1], 'b+', markersize=30, label='true value')
# plt.legend(fontsize=20)
plt.xlabel(r'$s_1$',fontsize=15)
plt.ylabel(r'$s_2$',fontsize=15)
plt.savefig('Results/FDS/MH_FDS_2_'+str(i)+str(j)+'.jpg')
plt.close()
